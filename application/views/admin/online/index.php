                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card shadow-0">
                            <div class="card-body p-0">
                                ...
                                <p class="text-sm text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                </p>
                                <form>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label text-sm" for="list2">Ed ut perspiciatis unde
                                            omnis iste</label>
                                    </div>
                                    <div class="form-check">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card text-center h-100 mb-0">
                            <div class="card-body">
                                ...
                                <p class="text-xs text-gray-600 mb-0">Lorem ipsum dolor sit amet, consectetur
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h2 class="h5 fw-normal mb-0"><a class="card-collapse-link text-dark d-block"
                                        data-bs-toggle="collapse" href="#feeds-box" aria-expanded="true">Your daily
                                        Feeds
                            ...
                            <div class="card-body-0">
                                <div class="collapse show" id="feeds-box" role="tabpanel">
                                    ...
                                    <div class="p-3 border-bottom border-gray-200">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex"><a class="flex-shrink-0" href="#!"><img
                                                        class="img-fluid rounded-circle" src="img/avatar-5.jpg"
                                                        alt="person" width="50"></a>
                                                <div class="ms-3">
                                                    <h5 class="fw-normal">Aria Smith</h5>
                                                    <p class="mb-0 text-xs text-gray-600 lh-1">Posted a new blog</p>
                                                    <small class="text-gray-600 fw-light">Today 5:60 pm -
                                                        12.06.2014</small>
                                                </div>
                                            </div>
                                    ...
                                    <div class="p-3 border-bottom border-gray-200">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex"><a class="flex-shrink-0" href="#!"><img
                                                        class="img-fluid rounded-circle" src="img/avatar-2.jpg"
                                                        alt="person" width="50"></a>
                                                <div class="ms-3">
                                    ...
                                    <div class="p-3 border-bottom border-gray-200">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex"><a class="flex-shrink-0" href="#!"><img
                                                        class="img-fluid rounded-circle" src="img/avatar-3.jpg"
                                                        alt="person" width="50"></a>
                                                <div class="ms-3">
                                    ...
                                    <div class="p-3 border-bottom border-gray-200">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex"><a class="flex-shrink-0" href="#!"><img
                                                        class="img-fluid rounded-circle" src="img/avatar-1.jpg"
                                                        alt="person" width="50"></a>
                                                <div class="ms-3">
                                        ...
                                        <div class="mt-3 ms-5 ps-3">
                                            ...
                                            <div class="text-end mt-2"><a class="btn btn-xs btn-dark py-1" href="#!"><i
                                                        class="fas fa-thumbs-up me-1"></i>Like</a></div>
                                        </div>
                                    </div>
                                    <!-- Item-->
                                    <div class="p-3">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex"><a class="flex-shrink-0" href="#!"><img
                                                        class="img-fluid rounded-circle" src="img/avatar-6.jpg"
                                                        alt="person" width="50"></a>
                                                <div class="ms-3">
