<section class="content p-3">
    <div class="box-header">
        <h2 class="box-title text-center text-uppercase">Thêm Mới Nhân Viên</h2>  
    </div>
  ...
  <form class="form-horizontal" action="<?php admin_url('quanlyNV/add')?>" method="post">
  <div class="box-body p-3">
        ...
        <div class="form-group mt-3">
            ...
            <input type="chucvu" class="form-control" name="chucvu" id="chucvu" value="<?php echo set_value('chucvu')?>">
